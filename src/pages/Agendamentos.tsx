...
const ConfirmDialog: React.FC<{
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-1 md:p-3">
            ...
            <div className="relative bg-gradient-to-br from-[#F4F9FF] to-[#E6F0FD] rounded-[24px] shadow-2xl border-2 border-blue-200 p-6 md:p-8 w-[99%] md:w-full md:max-w-md z-10 animate-in zoom-in-95 duration-200">
...
const AgendamentosPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-stretch justify-start px-4 pt-1 pb-2 lg:p-0 gap-y-2 overflow-x-hidden md:overflow-visible">
            ...
            <section className="w-full lg:w-screen lg:relative lg:left-1/2 lg:right-1/2 lg:-ml-[50vw] lg:-mr-[50vw] pt-2 lg:pt-[82px] pb-0 lg:pb-8 bg-transparent lg:premium-subheader-bg lg:border-t-[3px] lg:border-[#2563eb] lg:shadow-[0_12px_28px_rgba(0,0,0,0.08)] mb-[19px] md:mb-6">
                <div className="max-w-[1400px] mx-auto px-4 md:px-8 pt-0 sm:pt-6">
                    {/* Cabeçalho do Módulo */}
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start gap-3 flex-1">
                            <h2 className="premium-module-title gap-3">
