    ...
    return (
        <footer className={cn(
            ...
            <div className="w-full max-w-[1400px] mx-auto px-0 md:px-8">
                {/* ---------- MOBILE FOOTER ---------- */}
                <div className="flex flex-col items-center justify-center w-full md:hidden px-4 gap-[28px]">
                    {/* Bloco Principal Centralizado */}
                    <div className="flex items-center justify-center gap-[14px] w-full max-w-[340px]">
                        <img
                            src="/logo.png"
                            alt="Logo Calendário"
                    ...
                    <div className="flex flex-col items-center gap-[12px]">
                        <div style={{
                            ...
                            © 2026 Agenda • Bombeiros de Agudos
                        </div>

                        <div className="flex items-center justify-center gap-[8px]" style={{ fontSize: '14px', fontWeight: 500, color: 'rgba(255,255,255,0.60)' }}>
                            ...
                            >
                                <span style={{ color: 'rgba(255,255,255,0.8)', fontWeight: 600 }}>BM Vagner</span>
