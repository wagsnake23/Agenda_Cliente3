            ...
            >
                ...
                <div className={cn(
                    ...
                    <div className={cn(
                        ...
                        variant === 'modal' ? "mr-0" : "mr-3.5 md:mr-6"
                    )}>
                        <button
                            onClick={() => {
                        ...
                        <div className="flex flex-col gap-0">
                                    ...
                                    <div className="grid grid-cols-[1fr_1fr_88px] md:flex md:flex-row gap-x-2 gap-y-2.5 md:gap-3.5 w-full mt-2 md:mt-3 items-start">
                                        ...
                                        <div className="space-y-1.5 min-w-0 md:w-[120px]">
                                            ...
                                            <Input
                                                ...
                                                className={cn(
                                                    "w-full h-10 md:h-11 rounded-xl border-slate-200/60 focus:border-blue-500 focus:ring-blue-500 transition-all font-medium text-black px-2 md:px-3 cursor-pointer appearance-none bg-[#F8FAFC] shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.05)]",
                            ...
                            <div className="space-y-1 relative mt-5 md:mt-3">
                                ...
                                <textarea
                                    ...
                                    className={cn(
                                        "w-full min-h-[80px] md:min-h-[85px] p-2.5 md:p-3 rounded-xl border border-slate-200/60 bg-[#F8FAFC] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-medium text-black resize-none outline-none shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.05)]",
                                ...
                                {modoEdicao && (
                                    <Button
                                        ...
                                        className={cn(
                                            ...
                                            variant === 'modal'
                                                ? "bg-white border border-slate-300 text-slate-600 hover:bg-slate-50 hover:text-slate-700 shadow-sm"
                                                    ...
                                                    <DropdownMenu modal={false}>
                                                        <DropdownMenuTrigger asChild>
                                                                    <button
                                                                        ...
                                                                        className="w-7 h-9 flex items-center justify-center rounded-xl bg-blue-50/90 text-[#222] border border-blue-200/60 shadow-[0_2px_0_#93c5fd] hover:bg-blue-100 transition-all active:translate-y-[1.5px] active:shadow-none"
                                                                    >
