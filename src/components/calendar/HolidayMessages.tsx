                ...
                <React.Fragment key={i}>
                  ...
                  >
                    <div className={cn(
                      ...
                      {/* Date Block */}
                      <div className={cn(
                        "flex flex-col items-center justify-center bg-[rgba(239,68,68,0.08)] md:bg-[#f4f7fb] rounded-[14px] md:rounded-[18px] py-0 px-0 min-w-[64px] w-[64px] h-[64px] md:w-[72px] md:h-[72px] md:flex-col md:border-none md:shadow-none shrink-0"
                      )}>
                        <span className="font-[800] text-[22px] md:text-[32px] text-[#ef4444] md:text-[#2563eb] leading-none tracking-tight md:font-[800] uppercase md:uppercase">{String(day).padStart(2, '0')}</span>
                        <span className="font-[700] text-[11px] md:text-[13px] text-[#ef4444] md:text-[#64748b] opacity-90 mt-1 md:mt-[4px] leading-none uppercase md:uppercase md:font-[700]"><span className="md:inline hidden">/</span>{formattedMonth}</span>
                      </div>
                      ...
                      <div className="flex flex-row items-center gap-3 md:gap-[16px] flex-1 min-w-0 pr-1">
                          {/* Icon Circle */}
                          <div className={cn(
                              "w-[42px] h-[42px] md:w-[54px] md:h-[54px] rounded-full flex items-center justify-center shrink-0",
                              isInfoEvent ? "bg-slate-500/10 md:bg-slate-500/10" : "bg-red-500/10 md:bg-red-500/10"
                          )}>
                              {emoji ? (
                                <span className="text-[22px] md:text-[28px] filter saturate-[1.3] brightness-[1.1] emoji-desktop-colorful leading-none">{emoji}</span>
                              ) : (
