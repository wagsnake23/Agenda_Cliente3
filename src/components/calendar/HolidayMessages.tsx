...
const HolidayMessages: React.FC<HolidayMessagesProps> = ({ messages, highlightedDay, month, year }) => {
  ...
  return (
    <div className={cn(
      ...
      >
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#ef5350] to-[#ff8a80]" />
                  ...
                  >
                    <div className={cn(
                      ...
                      <div className={cn(
                        ...
                        <span className="font-bold text-[24px] md:text-[32px] text-slate-800 md:text-[#2563eb] leading-none tracking-tight md:font-[800] uppercase md:uppercase">{String(day).padStart(2, '0')}</span>
                      ...
                      <div className="flex flex-row items-center gap-3 md:gap-[16px] flex-1 min-w-0 pr-1">
                          {/* Icon Circle */}
                          <div className={cn(
                              "w-[40px] h-[40px] md:w-[54px] md:h-[54px] rounded-full flex items-center justify-center shrink-0",
                              isInfoEvent ? "bg-slate-500/10 md:bg-slate-500/10" : "bg-red-500/10 md:bg-red-500/10"
                          )}>
                              {emoji ? (
                                <span className="text-xl md:text-[28px] filter saturate-[1.3] brightness-[1.1] emoji-desktop-colorful leading-none">{emoji}</span>
                              ) : (
